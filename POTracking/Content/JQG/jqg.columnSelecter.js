// http://stackoverflow.com/questions/18163713/jqgrid-show-hide-columns-dialog
// http://www.ok-soft-gmbh.com/jqGrid/SimpleLocalGridWithColumnChooser5__.htm
// You can just include the code with $.jgrid.extend({columnChooser : function ... }); after jquery.jqGrid.min.js or jquery.jqGrid.src.js and overwrite the original version of columnChooser with the modified version.
$.jgrid.extend({
    columnChooser: function (opts) {
        ...
        /*
        HT: CAUTION - thi causes malfunction even after handling nullable
        SO: 18163713 & 9687201
        */
        //if (selector != null && selector.data != null && selector.data('dialog') != null) {
